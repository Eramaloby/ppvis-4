...
class Car(AbstractVehicle, Observable):
    def __init__(self,
        ...
        self.__fuel_tank: FuelTank = FuelTank(self.__logger, fill_level, tank_size, on_reserve_border)

        self.__fuel_tank_display: FuelTankDisplay = FuelTankDisplay(
            self.__fuel_tank,
            self.__logger)

        self.__engine: Engine = Engine(self.__logger, self.__fuel_tank)

        self.__driving_processor: DrivingProcessor = DrivingProcessor(
            self.__engine,
            self.__logger,
            acceleration_ratio,
        ...
        self.__driving_display: DrivingDisplay = DrivingDisplay(
    ...
    def brake_by(self, speed: float) -> None:
        self.__logger.log(f"Brake by {speed} in car class.")
    ...
    @property
    def __get_engine__(self) -> Engine:
    ...
    @property
    def __get_fuel_tank_display__(self) -> FuelTankDisplay:
        return self.__fuel_tank_display

    @property
    def __get_driving_display__(self) -> DrivingDisplay:
